...
return [
    ...
    */
    ...
    'number_withdrawal' => 'Trường :attribute phải nhỏ hơn số dư còn lại cộng thêm phí hoặc nhỏ nhất là 1 USDT',
    ...
    */
    ...
    'attributes' => [
        ...
        'new_password_confirmation' => 'xác nhận mật khẩu mói',
        'city'                  => 'thành phố',
        'country'               => 'quốc gia',
        'address'               => 'địa chỉ',
        'phone'                 => 'số điện thoại',
        ...
        'available'             => 'có sẵn',
        'size'                  => 'kích thước',
        'required-otp-login'    => 'yêu cầu otp login',
    ],
];