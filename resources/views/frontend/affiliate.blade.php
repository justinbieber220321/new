    ...
    <main>
        <section class="section-affiliate">
            <div class="affiliate-inner">
                        ...
                        <ul class="list-discount">
                            ...
                            <li class="discount-item">
                                ...
                                <div class="discount-detail">
                                    ...
                                    <p class="discount-text">Minimum 6F1, each F1 has personal bet greater than 500$</p>
                                </div>
                            </li>
                            <li class="discount-item">
                                ...
                                <div class="discount-detail">
                                    ...
                                    <p class="discount-text">Minimum 9F1, each F1 has personal bet greater than 500$</p>
                            ...
                            <li class="discount-item">
                                ...
                                <div class="discount-detail">
                                    ...
                                    <p class="discount-text">Minimum 15F1, each F1 has personal bet greater than 500$</p>
                ...
                <div class="affiliate-note"> <span>Note: </span>The same level from level 4 – level 5 is entitled to 30% of the income of the sub-branches with level greater than</div>
            </div>
        </section>
    </main>
@endsection